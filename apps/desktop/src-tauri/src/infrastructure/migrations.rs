...
const CREATE_PLAY_HISTORY_SQL: &str = include_str!("../../migrations/0005_create_play_history.sql");
...
lazy_static! {
    pub static ref MIGRATIONS: Migrations<'static> = Migrations::new(vec![
        ...
        M::up(CREATE_PLAY_HISTORY_SQL).comment("2026-06-26-create-play-history"),
    ]);
}
